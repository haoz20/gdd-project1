...
//     public static final String IMG_ENEMY = "src/images/alien.png";
    public static final String IMG_BOSS = "src/images/finalBoss.png";
...
//     public static final String IMG_EXPLOSION = "src/images/explosion.png";
    ...
    public static final String IMG_ENEMY = "src/images/aliens.png";
    public static final String IMG_PLAYER = "src/images/sprites.png";
    public static final String IMG_SHOT = "src/images/sprites.png";
    public static final String IMG_EXPLOSION = "src/images/aliens.png";

    public static final String IMG_TITLE = "src/images/title.png";
    public static final String IMG_POWERUP_SPEEDUP = "src/images/powerup-s.png";
    public static final String IMG_POWERUP_MULTISHOT = "src/images/powerup-ms.png";
}
